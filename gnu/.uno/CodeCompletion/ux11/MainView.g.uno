...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp21 = new global::Fuse.Drawing.SolidColor();
        var temp22 = new global::Fuse.Controls.Shadow();
        temp17.ItemSpacing = 50f;
        temp17.Children.Add(temp18);
        temp17.Children.Add(temp19);
        temp18.Color = float4(0.01568628f, 0.8f, 0.9960784f, 1f);
        temp18.Width = new Uno.UX.Size(200f, Uno.UX.Unit.Unspecified);
        temp18.Height = new Uno.UX.Size(200f, Uno.UX.Unit.Unspecified);
        temp19.Width = new Uno.UX.Size(200f, Uno.UX.Unit.Unspecified);
        temp19.Height = new Uno.UX.Size(200f, Uno.UX.Unit.Unspecified);
        temp19.Fills.Add(temp21);
        temp19.Strokes.Add(temp20);
        temp19.Children.Add(temp22);
        temp20.Color = float4(0.0627451f, 0.9764706f, 0.9921569f, 1f);
        temp20.Width = 3f;
        temp21.Color = float4(0.4078431f, 0.5215687f, 0.7686275f, 1f);
        temp21.Opacity = 0.6f;
        temp22.Angle = 134f;
        temp22.Distance = 20f;
        temp22.Size = 10f;
        temp22.Color = float4(0.9960784f, 0.02352941f, 0.02352941f, 1f);
