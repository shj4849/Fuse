...
{
    internal global::Fuse.Drawing.Stroke rec;
    static MainView()
    {
    ...
    void InitializeUX()
    {
        ...
        temp20.Value = "Layout";
        temp20.FontSize = 20f;
        temp20.Color = float4(0.9803922f, 0.9333333f, 0.007843138f, 1f);
        temp20.Alignment = Fuse.Elements.Alignment.Center;
        temp21.Children.Add(temp22);
        temp22.Color = float4(0.09803922f, 0.9176471f, 0.03921569f, 1f);
        temp22.Width = new Uno.UX.Size(100f, Uno.UX.Unit.Unspecified);
        temp22.Height = new Uno.UX.Size(100f, Uno.UX.Unit.Unspecified);
        temp22.Alignment = Fuse.Elements.Alignment.Default;
        temp22.Children.Add(temp23);
        temp23.Value = "Layout";
        temp23.FontSize = 20f;
        temp23.Color = float4(0.1607843f, 0.01176471f, 1f, 1f);
        temp23.Alignment = Fuse.Elements.Alignment.Center;
        temp24.Strokes.Add(rec);
        rec.Color = float4(1f, 0f, 0f, 1f);
        rec.Width = 4f;
        rec.Alignment = Fuse.Drawing.StrokeAlignment.Center;
