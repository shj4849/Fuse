...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp19 = new global::Fuse.Reactive.Data("Mi");
        var temp20 = new global::Fuse.Reactive.Data("Num1");
        var temp21 = new global::Fuse.Reactive.Data("Num2");
        var temp22 = new global::Fuse.Reactive.Data("Num3");
        var temp23 = new global::Fuse.Reactive.Data("Sum1");
        var temp24 = new global::Fuse.Reactive.Data("Num4");
        var temp25 = new global::Fuse.Reactive.Data("Num5");
        var temp26 = new global::Fuse.Reactive.Data("Num6");
        var temp27 = new global::Fuse.Reactive.Data("Sum2");
        var temp28 = new global::Fuse.Reactive.Data("Num7");
        var temp29 = new global::Fuse.Reactive.Data("Num8");
        var temp30 = new global::Fuse.Reactive.Data("Num9");
        var temp31 = new global::Fuse.Reactive.Data("Sum3");
        var temp32 = new global::Fuse.Reactive.Data("NumC");
        var temp33 = new global::Fuse.Reactive.Data("Num0");
        var temp34 = new global::Fuse.Reactive.Data("Result");
        var temp35 = new global::Fuse.Reactive.Data("Sum4");
        var temp36 = new global::Fuse.Reactive.JavaScript(__g_nametable);
        var temp37 = new global::Fuse.Controls.Grid();
        var temp38 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp18, Fuse.Reactive.BindingMode.Default);
        ...
        var temp54 = new global::MyButton();
        temp_eb15 = new global::Fuse.Reactive.EventBinding(temp34);
        var temp55 = new global::MyButton();
        temp_eb16 = new global::Fuse.Reactive.EventBinding(temp35);
        ...
        temp37.Children.Add(temp46);
        temp37.Children.Add(temp47);
        temp37.Children.Add(temp48);
        temp37.Children.Add(temp49);
        temp37.Children.Add(temp50);
        temp37.Children.Add(temp51);
        temp37.Children.Add(temp52);
        temp37.Children.Add(temp53);
        temp37.Children.Add(temp54);
        temp37.Children.Add(temp55);
        temp.FontSize = 50f;
        temp.Alignment = Fuse.Elements.Alignment.Center;
        global::Fuse.Controls.Grid.SetColumnSpan(temp, 4);
        temp.Bindings.Add(temp38);
        temp39.Text = "<-----";
        global::Fuse.Controls.Grid.SetColumnSpan(temp39, 4);
        global::Fuse.Gestures.Clicked.AddHandler(temp39, temp_eb0.OnEvent);
        temp39.Bindings.Add(temp_eb0);
        temp40.Text = "1";
        global::Fuse.Gestures.Clicked.AddHandler(temp40, temp_eb1.OnEvent);
        temp40.Bindings.Add(temp_eb1);
        temp41.Text = "2";
        global::Fuse.Gestures.Clicked.AddHandler(temp41, temp_eb2.OnEvent);
        temp41.Bindings.Add(temp_eb2);
        temp42.Text = "3";
        global::Fuse.Gestures.Clicked.AddHandler(temp42, temp_eb3.OnEvent);
        temp42.Bindings.Add(temp_eb3);
        temp43.Text = "+";
        global::Fuse.Gestures.Clicked.AddHandler(temp43, temp_eb4.OnEvent);
        temp43.Bindings.Add(temp_eb4);
        temp44.Text = "4";
        global::Fuse.Gestures.Clicked.AddHandler(temp44, temp_eb5.OnEvent);
        temp44.Bindings.Add(temp_eb5);
        temp45.Text = "5";
        global::Fuse.Gestures.Clicked.AddHandler(temp45, temp_eb6.OnEvent);
        temp45.Bindings.Add(temp_eb6);
        temp46.Text = "6";
        global::Fuse.Gestures.Clicked.AddHandler(temp46, temp_eb7.OnEvent);
        temp46.Bindings.Add(temp_eb7);
        temp47.Text = "-";
        global::Fuse.Gestures.Clicked.AddHandler(temp47, temp_eb8.OnEvent);
        temp47.Bindings.Add(temp_eb8);
        temp48.Text = "7";
        global::Fuse.Gestures.Clicked.AddHandler(temp48, temp_eb9.OnEvent);
        temp48.Bindings.Add(temp_eb9);
        temp49.Text = "8";
        global::Fuse.Gestures.Clicked.AddHandler(temp49, temp_eb10.OnEvent);
        temp49.Bindings.Add(temp_eb10);
        temp50.Text = "9";
        global::Fuse.Gestures.Clicked.AddHandler(temp50, temp_eb11.OnEvent);
        temp50.Bindings.Add(temp_eb11);
        temp51.Text = "*";
        global::Fuse.Gestures.Clicked.AddHandler(temp51, temp_eb12.OnEvent);
        temp51.Bindings.Add(temp_eb12);
        temp52.Text = "C";
        global::Fuse.Gestures.Clicked.AddHandler(temp52, temp_eb13.OnEvent);
        temp52.Bindings.Add(temp_eb13);
        temp53.Text = "0";
        global::Fuse.Gestures.Clicked.AddHandler(temp53, temp_eb14.OnEvent);
        temp53.Bindings.Add(temp_eb14);
        temp54.Text = "=";
        global::Fuse.Gestures.Clicked.AddHandler(temp54, temp_eb15.OnEvent);
        temp54.Bindings.Add(temp_eb15);
        temp55.Text = "/";
