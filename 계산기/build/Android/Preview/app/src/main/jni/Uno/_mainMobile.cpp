...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Fuse{struct AppBase_type;} ::g::Fuse::AppBase_type* MainView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* MyButton_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::App_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::MainView_typeof,
        (uType*(*)())&::g::MyButton_typeof,
