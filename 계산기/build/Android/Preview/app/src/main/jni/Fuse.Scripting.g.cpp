...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("C:/Users/t2/AppData/Local/Fusetools/Packages/Fuse.Scripting/1.4.0/NativeEvent.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[38/*"this.Contex...*/], ::STRINGS[39/*"C:/Users/t2...*/], 46, uArray::New(::TYPES[16/*object[]*/], 0));
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[76] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\1.4.0\\ScriptModule.Require.uno");
