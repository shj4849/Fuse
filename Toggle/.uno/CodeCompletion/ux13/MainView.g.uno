...
{
    internal global::Fuse.Controls.Panel MyToggle;
    ...
    void InitializeUX()
    {
        ...
        MyToggle = new global::Fuse.Controls.Panel();
        var temp17 = new global::Fuse.Gestures.SwipingAnimation(swipe);
        var temp18 = new global::Fuse.Animations.Move();
        var temp19 = new global::Fuse.Gestures.Clicked();
        var temp20 = new global::Fuse.Gestures.ToggleSwipeActive();
        handle = new global::Fuse.Controls.Rectangle();
        background = new global::Fuse.Controls.Rectangle();
        MyToggle.Width = new Uno.UX.Size(80f, Uno.UX.Unit.Unspecified);
        MyToggle.Height = new Uno.UX.Size(34f, Uno.UX.Unit.Unspecified);
        MyToggle.Name = __selector0;
        MyToggle.Children.Add(swipe);
        MyToggle.Children.Add(temp17);
        MyToggle.Children.Add(temp19);
        MyToggle.Children.Add(handle);
        MyToggle.Children.Add(background);
        swipe.Type = Fuse.Gestures.SwipeType.Active;
        swipe.Direction = Fuse.Gestures.SwipeDirection.Right;
        swipe.Length = 46f;
        swipe.Name = __selector1;
        temp17.Animators.Add(temp18);
        temp18.X = 46f;
        temp18.Target = handle;
        temp19.Actions.Add(temp20);
        temp20.Target = swipe;
        handle.CornerRadius = float4(3f, 3f, 3f, 3f);
        handle.Color = float4(1f, 0.5215687f, 0f, 1f);
        ...
        handle.Name = __selector2;
        background.CornerRadius = float4(4f, 4f, 4f, 4f);
        background.Color = float4(0.8666667f, 0.8666667f, 0.8666667f, 1f);
        background.Name = __selector3;
        this.Children.Add(MyToggle);
    }
    static global::Uno.UX.Selector __selector0 = "MyToggle";
    static global::Uno.UX.Selector __selector1 = "swipe";
    static global::Uno.UX.Selector __selector2 = "handle";
    static global::Uno.UX.Selector __selector3 = "background";
}
