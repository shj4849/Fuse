...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        {
            var __self = new global::MainPage();
    ...
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("articlePage", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ArticlePage();
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "articlePage";
    }
    ...
    void InitializeUX()
    {
        ...
        var articlePage = new Template1(this, this);
        this.Background = float4(0.8666667f, 0.8666667f, 0.8666667f, 1f);
        temp17.LineNumber = 2;
        temp17.FileName = "MainView.ux";
        temp17.File = new global::Uno.UX.BundleFileSource(import("../../../../../MainView.js"));
        router.Name = __selector0;
        temp18.DefaultPath = "mainPage";
        temp18.Color = float4(0.9921569f, 0.9764706f, 0.9764706f, 1f);
        temp18.Templates.Add(mainPage);
        temp18.Templates.Add(articlePage);
