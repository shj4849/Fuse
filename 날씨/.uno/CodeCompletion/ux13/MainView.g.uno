...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public override object New()
        {
            ...
            __self_Opacity_inst = new App1_FuseElementsElement_Opacity_Property(__self, __selector0);
            __self_Color_inst = new App1_FuseControlsShape_Color_Property(__self, __selector1);
            var temp = new global::Fuse.Reactive.Data("color");
            __self_Height_inst = new App1_FuseElementsElement_Height_Property(__self, __selector2);
    ...
    void InitializeUX()
    {
        ...
        myRectangle_Color_inst = new App1_FuseControlsShape_Color_Property(myRectangle, __selector0);
        myRectangle_CornerRadius_inst = new App1_FuseControlsRectangle_CornerRadius_Property(myRectangle, __selector1);
        __g_nametable = new global::Uno.UX.NameTable(null, __g_static_nametable);
        var temp = new global::Fuse.Reactive.Each();
        temp_Items_inst = new App1_FuseReactiveEach_Items_Property(temp, __selector2);
        ...
        myBlur_Radius_inst = new App1_FuseEffectsBlur_Radius_Property(myBlur, __selector3);
        ...
        var temp31 = new global::PageWithTitle();
        var temp32 = new global::Fuse.Reactive.JavaScript(__g_nametable);
        var temp33 = new global::Fuse.Controls.Panel();
        var temp34 = new global::Fuse.Controls.ScrollView();
        var temp35 = new global::Fuse.Controls.Panel();
        var temp36 = new global::Fuse.Layouts.ColumnLayout();
        var item = new Template(this, this);
        var temp37 = new global::Fuse.Reactive.DataBinding(temp_Items_inst, temp18, Fuse.Reactive.BindingMode.Default);
        temp_eb0 = new global::Fuse.Reactive.EventBinding(temp19);
        var temp38 = new global::PageWithTitle();
        var temp39 = new global::Fuse.Controls.Grid();
        var temp40 = new global::Fuse.Controls.Image();
        var temp41 = new global::Fuse.Controls.Slider();
        var temp42 = new global::Fuse.Triggers.ProgressAnimation();
        var temp43 = new global::Fuse.Animations.Change<float>(myBlur_Radius_inst);
        ...
        temp28.Duration = 0.3;
        temp29.Color = float4(0.9490196f, 0.01960784f, 0.01960784f, 1f);
        temp30.Color = float4(0.1176471f, 0.003921569f, 0.9882353f, 1f);
        temp31.Title = "Logic with JavaScript";
        temp31.Color = float4(1f, 1f, 1f, 1f);
        temp31.HeaderColor = float4(0.9647059f, 0.5607843f, 0.8431373f, 1f);
        temp31.HeaderTextColor = float4(1f, 1f, 1f, 1f);
        temp31.Instructions = "Tap the screen to add items";
        temp31.Children.Add(temp32);
        temp31.Children.Add(temp33);
        temp32.Code = "\n\t\t\t\t\tvar Observable = require('FuseJS/Observable');\n\t\t\t\t\titems = Observable();\n\t\t\t\t\tfunction addItem(){\n\t\t\t\t\t\titems.add({\n\t\t\t\t\t\t\tcolor : [Math.random(), Math.random(), Math.random(), 1],\n\t\t\t\t\t\t\theight : (Math.random() + 1.0) * 80\n\t\t\t\t\t\t});\n\t\t\t\t\t}\n\t\t\t\t\tmodule.exports = {\n\t\t\t\t\t\titems : items,\n\t\t\t\t\t\taddItem : addItem\n\t\t\t\t\t};\n\t\t\t\t";
        temp32.LineNumber = 38;
        temp32.FileName = "MainView.ux";
        global::Fuse.Gestures.Tapped.AddHandler(temp33, temp_eb0.OnEvent);
        ...
        temp38.Title = "Realtime effects";
        temp38.Color = float4(1f, 1f, 1f, 1f);
        temp38.HeaderColor = float4(0.172549f, 0.682353f, 0.2470588f, 1f);
        temp38.HeaderTextColor = float4(1f, 1f, 1f, 1f);
        temp38.Instructions = "Use the slider to blur the logo";
        temp38.Children.Add(temp39);
        temp39.RowCount = 2;
        temp39.Children.Add(temp40);
        temp39.Children.Add(temp41);
        temp40.Color = float4(0f, 0f, 0f, 1f);
        temp40.File = new global::Uno.UX.BundleFileSource(import("../../../Assets/FuseLogo.png"));
        temp40.Children.Add(myBlur);
        myBlur.Radius = 0f;
