...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:/Users/t2/AppData/Local/Fusetools/Packages/UnoCore/1.4.3/Source/Uno/Graphics/Texture2D.uno");
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[2/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[3/*"**** Invali...*/], versionString), 0, ::STRINGS[4/*"C:/Users/t2...*/], 114);
            }
            else             throw __t;
        }
    }
