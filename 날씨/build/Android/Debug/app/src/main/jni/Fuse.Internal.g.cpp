...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\AndroidSystemFont.uno
// ---------------------------------------------------------------------------------------------
...
void AndroidSystemFont::AddFamily(uString* name, uString* language, uString* variant)
{
    bool ret5;
    bool ret6;
    uString* lowerName = ::g::Uno::String::op_Equality(name, NULL) ? uCast<uString*>(NULL, ::TYPES[31/*string*/]) : (uString*)::g::Uno::String::ToLower(uPtr(name));
...
void AndroidSystemFont::EnsureFontsAdded()
{
    if (AndroidSystemFont::_families_ == NULL)
    {
        ...
        AndroidSystemFont::_aliases_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[31/*string*/], AndroidSystemFont__Alias_typeof(), NULL)));
        AndroidSystemFont::_familyNames_ = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::g::Uno::Collections::HashSet_typeof()->MakeType(::TYPES[31/*string*/], NULL)));
        AndroidSystemFont::AddFonts();
    }
}
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\Blender.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\Curves.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\DrawManager.uno
// -----------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\MiniList.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\ObjectList.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\SystemFont.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\FrustumMatrix.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Internal\ImageContainer.uno
// --------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.0\\Internal\\ImageContainer.uno");
    ...
    ::TYPES[27] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[29/*Uno.Collections.RootableList<Uno.UX.FileSource>*/], offsetof(ImageContainer, _files), 0,
...
uObject* ImageContainer::Files()
{
    if (_files == NULL)
    {
        _files = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[29/*Uno.Collections.RootableList<Uno.UX.FileSource>*/]));
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[4/*"ResampleMod...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 293, ::STRINGS[5/*"set_Resampl...*/]);
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Switching l...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 177, ::STRINGS[3/*"UpdateSourc...*/]);
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\RawPointer.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\RectPacker.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Internal\SizingContainer.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\Statistics.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Internal\VectorUtil.uno
// --------------------------------------------------------------------------------------
