...
static void VarArgFunction__Argument_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(VarArgFunction__Argument, Subscription), 0,
...
// protected object Compute(object left, object right) :30
...
// protected bool get_IsLeftOptional() :27
...
// protected object Compute(object left, object right) [instance] :30
...
// protected bool get_IsLeftOptional() [instance] :27
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), (uObject*)this, Compute(left, right));
}
...
void Clamp__Compute_fn(Clamp* __this, uObject* a, uObject* mn, uObject* mx, uObject** __retval)
{
    ...
    if (size == 1)
        return *__retval = uBox(::TYPES[3/*float*/], ::g::Uno::Math::Clamp1(av.X, mnv, mxv)), void();
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[0/*"clamp("*/], __this->First()), ::STRINGS[1/*","*/]), __this->Second()), ::STRINGS[1/*","*/]), __this->Third()), ::STRINGS[2/*")"*/]), void();
}
// }
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"("*/], __this->First()), ::STRINGS[4/*" ? "*/]), __this->Second()), ::STRINGS[5/*" : "*/]), __this->Third()), ::STRINGS[2/*")"*/]), void();
}
// }
...
{
    ::STRINGS[6] = uString::Const("C:/Users/t2/AppData/Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.4.0/FuseJS/DebugLog.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 0, ::STRINGS[6/*"C:/Users/t2...*/], 53);
    return NULL;
}
...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if ((uIs(obj, ::TYPES[2/*int*/]) || uIs(obj, ::TYPES[3/*float*/])) || uIs(obj, ::TYPES[4/*double*/]))
    {
        uPtr(builder)->AppendLine(::g::Uno::Object::ToString(uPtr(obj)));
        return;
    }

    if (uIs(obj, ::TYPES[5/*bool*/]))
    {
    ...
    if (uIs(obj, ::TYPES[7/*Fuse.Scripting.Function*/]))
    {
        uPtr(builder)->AppendLine(::STRINGS[9/*"function"*/]);
        return;
    }

    if (uIs(obj, ::TYPES[8/*Fuse.Scripting.Object*/]))
    {
        ::g::Fuse::Scripting::Object* o = uCast< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[8/*Fuse.Scripting.Object*/]);
    ...
    if (uIs(obj, ::TYPES[9/*Fuse.Scripting.Array*/]))
    {
        ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(obj, ::TYPES[9/*Fuse.Scripting.Array*/]);
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[13/*"Array["*/], uBox<int>(::TYPES[2/*int*/], uPtr(a)->Length())), ::STRINGS[14/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[11/*""*/], uBox<int>(::TYPES[2/*int*/], i)), ::STRINGS[12/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[16/*"log"*/], uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[17/*"dir"*/], uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[7/*"null"*/], 0, ::STRINGS[6/*"C:/Users/t2...*/], 39);
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[19/*"'"*/], ::g::Uno::Object::ToString(uPtr(__this->Value()))), ::STRINGS[19/*"'"*/]), void();
}
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[20/*"{"*/], __this->Key()), ::STRINGS[21/*"}"*/]), void();
}
...
{
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[22] = uString::Const("Cannot bind '");
    ::STRINGS[23] = uString::Const("' to property '");
    ::STRINGS[24] = uString::Const("'. The observable must contain exactly one ");
    ::STRINGS[25] = uString::Const(".");
    ::STRINGS[26] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\1.4.0\\DataBinding.uno");
    ::STRINGS[27] = uString::Const("InvalidListOperation");
    ::STRINGS[28] = uString::Const("TryPushAsMarshalledValue");
    ::STRINGS[29] = uString::Const("number");
    ::STRINGS[30] = uString::Const("string");
    ::STRINGS[31] = uString::Const("value that can be converted to type ");
    ...
    type->SetFields(3,
        ...
        ::TYPES[6/*string*/], offsetof(DataBinding, _registryName), 0,
...
{
    if (Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(Parent(), &_busyTask, 0, ::STRINGS[11/*""*/]);
}
...
{
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[22/*"Cannot bind '"*/], Key()), ::STRINGS[23/*"' to proper...*/]), ::g::Uno::UX::Selector__op_Implicit1(uPtr(Target())->Name())), ::STRINGS[24/*"'. The obse...*/]), DataBinding::TypeToJSName(uPtr(Target())->PropertyType())), ::STRINGS[25/*"."*/]), this, ::STRINGS[26/*"C:\\Users\\...*/], 90, ::STRINGS[27/*"InvalidList...*/], NULL);
}
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[26/*"C:\\Users\\...*/], 317, ::STRINGS[28/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
{
    return uIs(newValue, ::TYPES[16/*Uno.UX.Selector*/]) ? uUnbox< ::g::Uno::UX::Selector>(::TYPES[16/*Uno.UX.Selector*/], newValue) : uIs(newValue, ::TYPES[6/*string*/]) ? ::g::Uno::UX::Selector__New1(uCast<uString*>(newValue, ::TYPES[6/*string*/])) : uDefault< ::g::Uno::UX::Selector>();
}

// private static string TypeToJSName(Uno.Type t) [static] :81
uString* DataBinding::TypeToJSName(uType* t)
{
    if ((::g::Uno::Type::op_Equality(t, ::TYPES[2/*int*/]) || ::g::Uno::Type::op_Equality(t, ::TYPES[3/*float*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[4/*double*/]))
        return ::STRINGS[29/*"number"*/];

    if (::g::Uno::Type::op_Equality(t, ::TYPES[6/*string*/]))
        return ::STRINGS[30/*"string"*/];

    return ::g::Uno::String::op_Addition2(::STRINGS[31/*"value that ...*/], ::g::Uno::Type::FullName(uPtr(t)));
}
// }
...
{
    ::STRINGS[20] = uString::Const("{");
    ::STRINGS[32] = uString::Const("} not found in data context");
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[20] = ::g::Fuse::Reactive::IPropertySubscription_typeof();
    ::TYPES[21] = ::g::Fuse::Reactive::IObservableObject_typeof();
    ::TYPES[11] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(1,
        ...
        ::TYPES[20/*Fuse.Reactive.IPropertySubscription*/], offsetof(DataSubscription, _sub), 0);
}
...
{
    uObject* w = uAs<uObject*>(__this->_sub, ::TYPES[20/*Fuse.Reactive.IPropertySubscription*/]);

    if (w != NULL)
        return *__retval = ::g::Fuse::Reactive::IPropertySubscription::TrySetExclusive(uInterface(uPtr(w), ::TYPES[20/*Fuse.Reactive.IPropertySubscription*/]), __this->Key(), newValue), void();
...
{
    __this->DisposeSubscription();
    uObject* obs = uAs<uObject*>(provider, ::TYPES[21/*Fuse.Reactive.IObservableObject*/]);

    if (obs != NULL)
        __this->_sub = ::g::Fuse::Reactive::IObservableObject::Subscribe(uInterface(uPtr(obs), ::TYPES[21/*Fuse.Reactive.IObservableObject*/]), (uObject*)__this);
...
void DataSubscription::FindData()
{
    ...
    if (!_isResolved)
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[20/*"{"*/], Key()), ::STRINGS[32/*"} not found...*/]), _origin);
}
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[33/*"debug_log"*/], uDelegate::New(::TYPES[10/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[7/*"null"*/], 0, ::STRINGS[6/*"C:/Users/t2...*/], 17);
...
{
    ::TYPES[22] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[22/*Fuse.Reactive.IExpression*/], offsetof(JavaScript__Dependency, _Expression), 0,
...
void JavaScript__Dependency::Subscribe(::g::Fuse::Reactive::JavaScript* script)
{
    Unsubscribe();
    _script = script;
    _expSubscription = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(Expression()), ::TYPES[22/*Fuse.Reactive.IExpression*/]), (uObject*)script, (uObject*)this);
}
...
{
    ::TYPES[23] = ::g::Fuse::Reactive::IEventHandler_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::IScriptEvent_typeof();
    ::TYPES[25] = ::g::Fuse::Node_typeof();
    ::TYPES[26] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::EventRecord_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(3,
        ::TYPES[23/*Fuse.Reactive.IEventHandler*/], offsetof(EventBinding, _eventHandler), 0,
        ::TYPES[26/*Uno.Collections.List<Fuse.Reactive.EventRecord>*/], offsetof(EventBinding, _queuedEvents), 0);
}
...
{
    __this->_eventHandler = uAs<uObject*>(obj, ::TYPES[23/*Fuse.Reactive.IEventHandler*/]);
...
void EventBinding::OnEvent(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    ::g::Fuse::Reactive::EventRecord* e = ::g::Fuse::Reactive::EventRecord::New1(uAs<uObject*>(args, ::TYPES[24/*Fuse.Scripting.IScriptEvent*/]), uAs< ::g::Fuse::Node*>(sender, ::TYPES[25/*Fuse.Node*/]));

    if (_eventHandler != NULL)
        ::g::Fuse::Reactive::IEventHandler::Dispatch(uInterface(uPtr(_eventHandler), ::TYPES[23/*Fuse.Reactive.IEventHandler*/]), (uObject*)e);
    else
    {
        if (_queuedEvents == NULL)
            _queuedEvents = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[26/*Uno.Collections.List<Fuse.Reactive.EventRecord>*/]));
...
void EventBinding::ProcessQueuedEvents()
{
    ...
    if ((_eventHandler != NULL) && (_queuedEvents != NULL))
    {
        ...
        for (int i = 0; i < uPtr(events)->Count(); i++)
            ::g::Fuse::Reactive::IEventHandler::Dispatch(uInterface(uPtr(_eventHandler), ::TYPES[23/*Fuse.Reactive.IEventHandler*/]), (uObject*)(::g::Uno::Collections::List__get_Item_fn(uPtr(events), uCRef<int>(i), &ret2), ret2));
    }
}
...
static void EventRecord_build(uType* type)
{
    ::TYPES[25] = ::g::Fuse::Node_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::IScriptEvent_typeof();
    ::TYPES[27] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::UX::Selector_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[25/*Fuse.Node*/], offsetof(EventRecord, _node), 0,
        uObject_typeof(), offsetof(EventRecord, _data), 0,
        ::g::Uno::UX::Selector_typeof(), offsetof(EventRecord, _sender), 0,
        ::TYPES[27/*Uno.Collections.Dictionary<string, object>*/], offsetof(EventRecord, _args), 0);
}
...
{
    bool value_ = *value;
    __this->AddObject(key, uBox(::TYPES[5/*bool*/], value_));
}
...
{
    double value_ = *value;
    __this->AddObject(key, uBox(::TYPES[4/*double*/], value_));
}
...
{
    int value_ = *value;
    __this->AddObject(key, uBox(::TYPES[4/*double*/], (double)value_));
}
...
{
    _node = uAs< ::g::Fuse::Node*>(sender, ::TYPES[25/*Fuse.Node*/]);
    ...
    if (args != NULL)
        ::g::Fuse::Scripting::IScriptEvent::Serialize(uInterface(uPtr(args), ::TYPES[24/*Fuse.Scripting.IScriptEvent*/]), (uObject*)this);
}
...
{
    if (_args == NULL)
        _args = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<string, object>*/]));
...
{
    ::STRINGS[34] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[22] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[28] = ::g::Fuse::Reactive::IWriteable_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(1,
        ...
        ::TYPES[22/*Fuse.Reactive.IExpression*/], offsetof(ExpressionBinding, _Key), 0);
}
...
void ExpressionBinding__OnRooted_fn(ExpressionBinding* __this)
{
    ...
    __this->_expressionSub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(__this->Key()), ::TYPES[22/*Fuse.Reactive.IExpression*/]), (uObject*)__this, (uObject*)__this);
}
...
{
    U_THROW(::g::Uno::Exception::New2(::STRINGS[34/*"The binding...*/]));
}
...
{
    return uIs((uObject*)_expressionSub, ::TYPES[28/*Fuse.Reactive.IWriteable*/]);
}
...
{
    ::g::Fuse::Reactive::IWriteable::TrySetExclusive(uInterface(uPtr(_expressionSub), ::TYPES[28/*Fuse.Reactive.IWriteable*/]), value);
}
// }
...
void InnerListener__Dispose_fn(InnerListener* __this)
{
    ...
    if (__this->_obsSubs != NULL)
    {
        ...
        {
            {
                while (enum1.MoveNext(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[22/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL)))
                {
                    InnerListener__ObservableSubscription* k = enum1.Current(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[22/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL));
                    uPtr(k)->Dispose();
                }
            }
            {
                enum1.Dispose(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[22/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL));
            }
        }
...
void InnerListener__FuseReactiveIListenerOnNewData_fn(InnerListener* __this, uObject* source, uObject* value)
{
    ...
    {
        if (__this->_obsSubs == NULL)
            __this->_obsSubs = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[22/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL)));
...
void Instantiator::ctor_3()
{
    ...
    _dataMap = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], Instantiator__WindowItem_typeof(), NULL)));
...
bool Instantiator::AddMatchingTemplates(Instantiator__WindowItem* item, Instantiator__TemplateMatch f)
{
    ...
    {
        uPtr(item)->Nodes = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[34/*Uno.Collections.List`1*/]->MakeType(::TYPES[25/*Fuse.Node*/], NULL)));
...
{
    ::g::Fuse::Node* elm = uAs< ::g::Fuse::Node*>(uPtr(f)->New1(), ::TYPES[25/*Fuse.Node*/]);
...
void Instantiator::CompleteNodeAction()
{
    if (Reuse() == 1)
    {
        ...
        {
            ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)Instantiator__RemovePendingAvailableItemsAction_fn, this), -1, 2);
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    if (reuse)
        uPtr(Parent())->InsertOrMoveNodesAfter(lastNode, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret9), ret9)));
    else
        uPtr(Parent())->InsertNodesAfter(lastNode, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret10), ret10)));
}
...
{
    uArray* e = uAs<uArray*>(_items, uObject_typeof()->Array());
...
int Instantiator::GetDataCount()
{
    ...
    if (a != NULL)
        return ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[13/*Fuse.IArray*/]));
...
{
    uObject* so = uAs<uObject*>(data, ::TYPES[33/*Fuse.IObject*/]);

    if ((so != NULL) && ::g::Uno::String::op_Inequality(key, NULL))
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[33/*Fuse.IObject*/]), key))
            return ::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[33/*Fuse.IObject*/]), key);
    }
...
Instantiator__TemplateMatch Instantiator::GetDataTemplate(uObject* data)
{
    ...
    if (useTemplate == NULL)
    {
        uString* key = uAs<uString*>(GetDataKey(data, MatchKey()), ::TYPES[6/*string*/]);
...
void Instantiator::InsertNewWindowItem(int windowIndex, uObject* data)
{
    ...
    else if (!_pendingNew)
    {
        if (Defer() == 2)
            ...
            ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)Instantiator__CompleteWindowItemsAction_fn, this), -1, 2);
...
void Instantiator::OnUpdatedWindowItems()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)Instantiator__PostUpdatedWindowItems_fn, this), -1, 2);
}
...
void Instantiator::PatchTo(uObject* values)
{
    ...
    ::g::Uno::Collections::List* newIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[34/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    int limit = CalcOffsetLimitCountOf(::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[13/*Fuse.IArray*/])));
    ...
    ::g::Uno::Collections::List* curIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[34/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    ...
    for (int i2 = 0; i2 < uPtr(ops)->Count(); ++i2)
    {
        ...
        switch (op.Op)
        {
            ...
            case 1:
            {
                InsertNewWindowItem(DataToWindowIndex(op.A + Offset()), ::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[13/*Fuse.IArray*/]), op.Data));
                break;
            }
            case 2:
            {
...
void Instantiator::RemoveFromParent(::g::Fuse::Node* n)
{
    if (::g::Uno::Delegate::op_Equality(_completedRemove, NULL))
        _completedRemove = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), (void*)Instantiator__CompletedRemove_fn, this);
...
void Instantiator::Repopulate()
{
    ...
    else
    {
        ...
        if (a != NULL)
            ...
            for (int i1 = 0; i1 < ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[13/*Fuse.IArray*/])); i1++)
                InsertNew(i1);
    }
...
void Instantiator::UpdateData(Instantiator__WindowItem* item, uObject* oldData)
{
    ...
    uObject* obs = uAs<uObject*>(uPtr(item)->Data, ::TYPES[31/*Fuse.Reactive.IObservable*/]);
...
{
    UpdatedWindowItems1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(UpdatedWindowItems1, value), ::TYPES[29/*Uno.Action*/]);
}
...
{
    UpdatedWindowItems1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(UpdatedWindowItems1, value), ::TYPES[29/*Uno.Action*/]);
}
// }
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 1)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("too many parameters for "), ::g::Uno::UX::Selector__op_Implicit1(__this->_item)), __this, ::STRINGS[36/*"C:\\Users\\...*/], 34, uString::Const("Subscribe"), NULL);
        return *__retval = NULL, void();
    }

    ::g::Fuse::Reactive::Expression* node = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 0) ? (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Arguments()), ::TYPES[40/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(0), &ret1), ret1) : NULL;
...
{
    ::STRINGS[35] = uString::Const("invalid search node for InstantiatorFunction");
    ::STRINGS[36] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\1.4.0\\InstantiatorFunction.uno");
    ::STRINGS[37] = uString::Const("OnNewNode");
    ::STRINGS[38] = uString::Const("Could not find an Instantiator");
    ::STRINGS[39] = uString::Const("Unable to resolve Instantiator node");
    ::TYPES[22] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[29] = ::g::Uno::Action_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[25] = ::g::Fuse::Node_typeof();
    ::TYPES[12] = ::g::Fuse::Reactive::IContext_typeof();
    ::TYPES[30] = ::TYPES[25/*Fuse.Node*/]->MakeMethod(0/*FindBehavior<Fuse.Reactive.Instantiator>*/, ::g::Fuse::Reactive::Instantiator_typeof(), NULL);
    ::TYPES[11] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
    ...
    type->SetFields(2,
        ...
        ::TYPES[22/*Fuse.Reactive.IExpression*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _node), 0,
        ::g::Fuse::Reactive::Instantiator_typeof(), offsetof(InstantiatorFunction__InstantiatorSubscription, _instantiator), 0,
        ::TYPES[25/*Fuse.Node*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _instance), 0,
...
void InstantiatorFunction__InstantiatorSubscription__Dispose_fn(InstantiatorFunction__InstantiatorSubscription* __this)
{
    ...
    if (__this->_instantiator != NULL)
        uPtr(__this->_instantiator)->remove_UpdatedWindowItems(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, __this));
...
void InstantiatorFunction__InstantiatorSubscription::ctor_1(::g::Fuse::Reactive::InstantiatorFunction* expr, ::g::Uno::UX::Selector item, uObject* listener, uObject* context, uObject* node)
{
    ...
    if (_node == NULL)
        ...
        _nodeSub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(_node), ::TYPES[22/*Fuse.Reactive.IExpression*/]), context, (uObject*)this);
}
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    {
        uPtr(_instantiator)->remove_UpdatedWindowItems(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, this));
        _instantiator = NULL;
        _instance = NULL;
    }

    ind1 = uAs< ::g::Fuse::Node*>(obj, ::TYPES[25/*Fuse.Node*/]);
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"invalid sea...*/], this, ::STRINGS[36/*"C:\\Users\\...*/], 92, ::STRINGS[37/*"OnNewNode"*/], NULL);
        return;
    }

    _instantiator = ((::g::Fuse::Reactive::Instantiator*)uPtr(searchNode)->FindBehavior(::TYPES[30/*Fuse.Node.FindBehavior<Fuse.Reactive.Instantiator>*/]));

    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Could not f...*/], this, ::STRINGS[36/*"C:\\Users\\...*/], 99, ::STRINGS[37/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[39/*"Unable to r...*/], this, ::STRINGS[36/*"C:\\Users\\...*/], 110, ::STRINGS[37/*"OnNewNode"*/]);
        return;
    }
    ...
    {
        _instance = p;
        uPtr(_instantiator)->add_UpdatedWindowItems(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, this));
        PushValue();
    }
}
...
void InstantiatorFunction__InstantiatorSubscription::PushValue()
{
    ...
    if (q != -1)
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), (uObject*)_expr, uBox<int>(::TYPES[2/*int*/], q));
}
...
uObject* JavaScript::Dependencies()
{
    if (_dependencies == NULL)
        _dependencies = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[34/*Uno.Collections.List`1*/]->MakeType(JavaScript__Dependency_typeof(), NULL)));
...
void Lerp__Compute_fn(Lerp* __this, uObject* a, uObject* b, uObject* t, uObject** __retval)
{
    ...
    {
        case 1:
            return *__retval = uBox(::TYPES[3/*float*/], ::g::Uno::Math::Lerp1(av.X, bv.X, tv)), void();
        case 2:
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[40/*"lerp("*/], __this->First()), ::STRINGS[1/*","*/]), __this->Second()), ::STRINGS[1/*","*/]), __this->Third()), ::STRINGS[2/*")"*/]), void();
}
// }
...
{
    ::STRINGS[41] = uString::Const("Index must be a number: ");
    ::STRINGS[42] = uString::Const("Index was outside the bounds of the array");
    ::STRINGS[43] = uString::Const("Object does not contain the given key '");
    ::STRINGS[19] = uString::Const("'");
    ::STRINGS[44] = uString::Const("Look-up operator not supported on collection type: ");
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[15] = ::g::Fuse::Reactive::IObservableArray_typeof();
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[11] = ::g::Fuse::Reactive::IListener_typeof();
    ::TYPES[13] = ::g::Fuse::IArray_typeof();
    ::TYPES[32] = ::g::Fuse::MarshalException_typeof();
    ::TYPES[33] = ::g::Fuse::IObject_typeof();
    ::TYPES[21] = ::g::Fuse::Reactive::IObservableObject_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
...
{
    DisposeIndexSub();
    uObject* obs = uAs<uObject*>(ind, ::TYPES[31/*Fuse.Reactive.IObservable*/]);
...
void LookUp__LookUpSubscription::ResultChanged()
{
    ...
    if (arr != NULL)
    {
        ...
        {
            if (uIs(__t.Exception, ::TYPES[32/*Fuse.MarshalException*/]))
            {
                ::g::Fuse::MarshalException* me = (::g::Fuse::MarshalException*)__t.Exception;
                SetDiagnostic(::g::Uno::String::op_Addition2(::STRINGS[41/*"Index must ...*/], uPtr(me)->Message()), (uObject*)uPtr(_lu)->Index());
                return;
            }
            else             throw __t;
        }
        ...
        if ((index >= 0) && (index < ::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[13/*Fuse.IArray*/]))))
            ...
            SetDiagnostic(::STRINGS[42/*"Index was o...*/], (uObject*)uPtr(_lu)->Index());

        return;
    }

    uObject* obj = uAs<uObject*>(_collection, ::TYPES[33/*Fuse.IObject*/]);

    if (obj != NULL)
    {
        uObject* obsObj = uAs<uObject*>(obj, ::TYPES[21/*Fuse.Reactive.IObservableObject*/]);

        if (obsObj != NULL)
            _colObsObjSub = ::g::Fuse::Reactive::IObservableObject::Subscribe(uInterface(uPtr(obsObj), ::TYPES[21/*Fuse.Reactive.IObservableObject*/]), (uObject*)this);

        uString* key = ::g::Uno::Object::ToString(uPtr(_index));

        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[33/*Fuse.IObject*/]), key))
            PushNewData(::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[33/*Fuse.IObject*/]), key));
        else
            SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[43/*"Object does...*/], key), ::STRINGS[19/*"'"*/]), (uObject*)uPtr(_lu)->Index());

        return;
    }

    SetDiagnostic(::g::Uno::String::op_Addition1(::STRINGS[44/*"Look-up ope...*/], _collection), (uObject*)uPtr(_lu)->Collection());
}
...
{
    ::STRINGS[45] = uString::Const("Invalid params");
    ::STRINGS[34] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[29] = ::g::Uno::Action_typeof();
    ::TYPES[22] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ...
    type->SetFields(0,
        ::TYPES[22/*Fuse.Reactive.IExpression*/], offsetof(NodeExpressionBinding, _expr), 0,
...
void NodeExpressionBinding::ctor_(uObject* expr, ::g::Fuse::Node* node, uObject* listener)
{
    if (((expr == NULL) || (node == NULL)) || (listener == NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[45/*"Invalid par...*/]));

    _expr = expr;
    _listener = listener;
    _node = node;
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)NodeExpressionBinding__CompleteInit_fn, this), -1, 2);
}
...
void NodeExpressionBinding::CompleteInit()
{
    ...
    _sub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(_expr), ::TYPES[22/*Fuse.Reactive.IExpression*/]), (uObject*)this, _listener);
}
...
{
    ::STRINGS[46] = uString::Const("An observable with write-back is expected");
    ::STRINGS[47] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\1.4.0\\ObserverMap.uno");
    ::STRINGS[48] = uString::Const("Attach");
    ::TYPES[34] = ::g::Uno::Collections::List_typeof();
    ::TYPES[15] = ::g::Fuse::Reactive::IObservableArray_typeof();
    ::TYPES[19] = ::g::Fuse::Reactive::ISubscription_typeof();
    ::TYPES[35] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Fuse::IArray_typeof();
    ::TYPES[36] = ::g::Fuse::Reactive::UnmappedView_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetPrecalc(
    ...
    type->SetInterfaces(
        ::TYPES[35/*Fuse.Reactive.IObserver*/], offsetof(ObserverMap_type, interface0));
    type->SetFields(0,
        ::TYPES[34/*Uno.Collections.List`1*/]->MakeType(type->T(0), NULL), offsetof(ObserverMap, _list), 0,
        ...
        ::TYPES[35/*Fuse.Reactive.IObserver*/], offsetof(ObserverMap, _slave), 0,
...
void ObserverMap__FuseReactiveIObserverOnAdd_fn(ObserverMap* __this, uObject* addedValue)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnAdd(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), addedValue);
}
...
void ObserverMap__FuseReactiveIObserverOnClear_fn(ObserverMap* __this)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnClear(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]));
}
...
void ObserverMap__FuseReactiveIObserverOnFailed_fn(ObserverMap* __this, uString* message)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnFailed(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), message);
}
...
void ObserverMap__FuseReactiveIObserverOnInsertAt_fn(ObserverMap* __this, int* index, uObject* value)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnInsertAt(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), index_, value);
}
...
void ObserverMap__FuseReactiveIObserverOnNewAll_fn(ObserverMap* __this, uObject* values)
{
    ...
    for (int i = 0; i < ::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[13/*Fuse.IArray*/])); ++i)
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnNewAll(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), values);
}
...
void ObserverMap__FuseReactiveIObserverOnNewAt_fn(ObserverMap* __this, int* index, uObject* newValue)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnNewAt(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), index_, newValue);
}
...
void ObserverMap__FuseReactiveIObserverOnRemoveAt_fn(ObserverMap* __this, int* index)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnRemoveAt(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), index_);
}
...
void ObserverMap__FuseReactiveIObserverOnSet_fn(ObserverMap* __this, uObject* newValue)
{
    ...
    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnSet(uInterface(uPtr(__this->_slave), ::TYPES[35/*Fuse.Reactive.IObserver*/]), newValue);
}
...
void ObserverMap::Attach(uObject* src, uObject* slave)
{
    ...
    if (_observable != NULL)
    {
        ...
        if (_subscription == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"An observab...*/], this, ::STRINGS[47/*"C:\\Users\\...*/], 68, ::STRINGS[48/*"Attach"*/]);
    }

    ::g::Fuse::Reactive::IObserver::OnNewAll(uInterface((uObject*)this, ::TYPES[35/*Fuse.Reactive.IObserver*/]), src);
    _slave = slave;
}
...
{
    ::STRINGS[49] = uString::Const("{Resource ");
    ::STRINGS[32] = uString::Const("} not found in data context");
    ::TYPES[29] = ::g::Uno::Action_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[37] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[11] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
...
void ResourceSubscription::ctor_(uObject* source, ::g::Fuse::Node* origin, uString* key, uObject* listener, uType* type)
{
    ...
    _type = type;
    _listener = listener;
    ::g::Fuse::Resources::ResourceRegistry::AddResourceChangedHandler(_key, uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)ResourceSubscription__OnChanged_fn, this));
    OnChanged();
}
...
{
    ClearDiagnostic();
    ::g::Fuse::Resources::ResourceRegistry::RemoveResourceChangedHandler(_key, uDelegate::New(::TYPES[29/*Uno.Action*/], (void*)ResourceSubscription__OnChanged_fn, this));
    _listener = NULL;
    _origin = NULL;
}
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(_origin)->TryGetResource(_key, uDelegate::New(::TYPES[37/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), _source, resource);
    else
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[49/*"{Resource "*/], _key), ::STRINGS[32/*"} not found...*/]), _origin);
}
...
// protected void OnNewArguments(Fuse.Reactive.VarArgFunction.Argument[] args, Fuse.Reactive.IListener listener) :170
...
// protected void OnNewArguments(Fuse.Reactive.VarArgFunction.Argument[] args, Fuse.Reactive.IListener listener) [instance] :170
...
static void TernaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[0/*Uno.IDisposable*/], offsetof(TernaryOperator__Subscription, _firstSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(TernaryOperator__Subscription, _secondSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(TernaryOperator__Subscription, _thirdSub), 0,
        ::TYPES[11/*Fuse.Reactive.IListener*/], offsetof(TernaryOperator__Subscription, _listener), 0);
}
...
void TernaryOperator__Subscription::OnNewOperands(uObject* first, uObject* second, uObject* third)
{
    ...
    {
        {
            ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), (uObject*)_to, uPtr(_to)->Compute(first, second, third));
        }
    }
...
static void UnaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(UnaryOperator__Subscription, _listener), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(UnaryOperator__Subscription, _operandSub), 0);
}
...
// protected void OnNewOperand(object value) :69
...
// protected void OnNewOperand(object value) [instance] :69
...
static void BinaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[0/*Uno.IDisposable*/], offsetof(BinaryOperator__Subscription, _leftSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(BinaryOperator__Subscription, _rightSub), 0,
...
static void QuaternaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[0/*Uno.IDisposable*/], offsetof(QuaternaryOperator__Subscription, _firstSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(QuaternaryOperator__Subscription, _secondSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(QuaternaryOperator__Subscription, _thirdSub), 0,
        ::TYPES[0/*Uno.IDisposable*/], offsetof(QuaternaryOperator__Subscription, _fourthSub), 0,
        ::TYPES[11/*Fuse.Reactive.IListener*/], offsetof(QuaternaryOperator__Subscription, _listener), 0);
}
...
void QuaternaryOperator__Subscription::OnNewOperands(uObject* first, uObject* second, uObject* third, uObject* fourth)
{
    ...
    {
        {
            ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), (uObject*)_qo, uPtr(_qo)->Compute(first, second, third, fourth));
        }
    }
...
{
    ::TYPES[38] = ::g::Fuse::Reactive::VarArgFunction__Argument_typeof()->Array();
    ::TYPES[39] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    ::TYPES[40] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ...
        ::TYPES[38/*Fuse.Reactive.VarArgFunction.Argument[]*/], offsetof(VarArgFunction__Subscription, _arguments), 0,
...
void VarArgFunction__Subscription__OnNewData_fn(VarArgFunction__Subscription* __this, uObject* source, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        if ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[40/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret2), ret2) == source)
        {
...
void VarArgFunction__Subscription::ctor_1(::g::Fuse::Reactive::VarArgFunction* func, uObject* context)
{
    ctor_();
    _func = func;
    _arguments = uArray::New(::TYPES[38/*Fuse.Reactive.VarArgFunction.Argument[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(func)->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])));
    _context = context;

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(func->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
...
void VarArgFunction__Subscription::Init()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(_func)->Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        uPtr(uPtr(_arguments)->Strong< ::g::Fuse::Reactive::VarArgFunction__Argument*>(i))->Subscription = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(_func)->Arguments()), ::TYPES[40/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret1), ret1))->Subscribe(_context, (uObject*)this);
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[11/*Fuse.Reactive.IListener*/]), (uObject*)this, Compute(operand));
}
...
{
    ::g::Fuse::Reactive::Expression* ret1;
    uString* q = ::g::Uno::String::op_Addition2(funcName, ::STRINGS[3/*"("*/]);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Arguments()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); ++i)
    {
        if (i > 0)
            q = ::g::Uno::String::op_Addition2(q, ::STRINGS[1/*","*/]);

        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::Object::ToString(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Arguments()), ::TYPES[40/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret1), ret1))));
    }
