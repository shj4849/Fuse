...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\FuseJS\Builtins.uno
// ------------------------------------------------------------------------------------------------
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeoutff29abd6())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promisemin8262893e())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnostics7c89eba5()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observablebead7a7c()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\FuseJS\Timer.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\FuseJS\DiagnosticsImpl.uno
// -------------------------------------------------------------------------------------------------------
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.4.0\\FuseJS\\DiagnosticsImpl.uno");
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\FuseJS\Http.uno
// --------------------------------------------------------------------------------------------
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.delete(): The parameter is not a valid timer handle"), this, uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.4.0\\FuseJS\\Timer.uno"), 133, uString::Const("Delete"));
        }
        else         throw __t;
    }
