...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Internal\Clicker.uno
// -------------------------------------------------------------------------------------
...
static void Clicker_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::Gestures::ClickerEventHandler_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], offsetof(Clicker, ClickedEvent1), 0,
        ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], offsetof(Clicker, LongPressedEvent1), 0,
        ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], offsetof(Clicker, PressingEvent1), 0,
        ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], offsetof(Clicker, TappedEvent1), 0,
...
void Clicker__FuseInputIGestureOnCaptureChanged_fn(Clicker* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how, int* prev)
{
    if (::g::Uno::Delegate::op_Inequality(__this->LongPressedEvent1, NULL) && !__this->_hasUpdate)
    {
        ...
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)Clicker__Update_fn, __this), 0);
    }
...
{
    ClickedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ClickedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    ClickedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ClickedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    LongPressedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(LongPressedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    LongPressedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(LongPressedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    PressingEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PressingEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    PressingEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PressingEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    TappedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(TappedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
{
    TappedEvent1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(TappedEvent1, value), ::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/]);
}
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Internal\Helpers.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\WhileEdgeSwiped.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\KeepInView.uno
// -------------------------------------------------------------------------------
...
{
    ::TYPES[2] = ::g::Fuse::Input::FocusGainedHandler_typeof();
    ::TYPES[3] = ::g::Fuse::Input::FocusLostHandler_typeof();
    type->SetDependencies(
...
void KeepFocusInView__OnRooted_fn(KeepFocusInView* __this)
{
    ...
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[2/*Fuse.Input.FocusGainedHandler*/], (void*)KeepFocusInView__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[3/*Fuse.Input.FocusLostHandler*/], (void*)KeepFocusInView__OnLostFocus_fn, __this));
}

// protected override sealed void OnUnrooted() :115
void KeepFocusInView__OnUnrooted_fn(KeepFocusInView* __this)
{
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[2/*Fuse.Input.FocusGainedHandler*/], (void*)KeepFocusInView__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[3/*Fuse.Input.FocusLostHandler*/], (void*)KeepFocusInView__OnLostFocus_fn, __this));
...
{
    ::TYPES[4] = ::g::Fuse::PlacedHandler_typeof();
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface5));
    type->SetFields(15,
        ::TYPES[5/*Fuse.Elements.Element*/], offsetof(KeepInViewCommon, _target), 0,
        ::g::Uno::Bool_typeof(), offsetof(KeepInViewCommon, _attached), 0,
        ::TYPES[5/*Fuse.Elements.Element*/], offsetof(KeepInViewCommon, _rootElement), 0);
}
...
void KeepInViewCommon__OnRooted_fn(KeepInViewCommon* __this)
{
    ...
    __this->_rootElement = uAs< ::g::Fuse::Elements::Element*>(__this->Parent(), ::TYPES[5/*Fuse.Elements.Element*/]);

    if (__this->_rootElement != NULL)
    {
        uPtr(__this->_rootElement)->add_Placed(uDelegate::New(::TYPES[4/*Fuse.PlacedHandler*/], (void*)KeepInViewCommon__Update_fn, __this));
        __this->AttachElement();
    }
}
...
void KeepInViewCommon__OnUnrooted_fn(KeepInViewCommon* __this)
{
    if (__this->_rootElement != NULL)
    {
        uPtr(__this->_rootElement)->remove_Placed(uDelegate::New(::TYPES[4/*Fuse.PlacedHandler*/], (void*)KeepInViewCommon__Update_fn, __this));
...
void KeepInViewCommon::AttachElement()
{
    ...
    uPtr(_target)->add_Placed(uDelegate::New(::TYPES[4/*Fuse.PlacedHandler*/], (void*)KeepInViewCommon__Update_fn, this));
    _attached = true;
    Update(NULL, NULL);
}
...
void KeepInViewCommon::ReleaseElement()
{
    ...
    uPtr(_target)->remove_Placed(uDelegate::New(::TYPES[4/*Fuse.PlacedHandler*/], (void*)KeepInViewCommon__Update_fn, this));
    _attached = false;
}
...
void KeepInViewCommon::Target(::g::Fuse::Node* value)
{
    ...
    while (v != NULL)
    {
        _target = uAs< ::g::Fuse::Elements::Element*>(v, ::TYPES[5/*Fuse.Elements.Element*/]);
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\RangeControls\LinearRangeBehavior.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void LinearRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.4.0\\RangeControls\\LinearRangeBehavior.uno");
    ::STRINGS[2] = uString::Const("OnRooted");
    ::STRINGS[3] = uString::Const("Element");
    ::TYPES[6] = ::g::Fuse::Controls::RangeControl_typeof();
    ::TYPES[5] = ::g::Fuse::Elements::Element_typeof();
    type->SetDependencies(
    ...
    type->SetFields(15,
        ::TYPES[6/*Fuse.Controls.RangeControl*/], offsetof(LinearRangeBehavior, Control), 0,
        ::g::Fuse::Layouts::Orientation_typeof(), offsetof(LinearRangeBehavior, _orientation), 0,
        ::TYPES[5/*Fuse.Elements.Element*/], offsetof(LinearRangeBehavior, _boundsElement), 0,
...
void LinearRangeBehavior__OnRooted_fn(LinearRangeBehavior* __this)
{
    ...
    if (__this->Control == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[0/*"RangeControl"*/], __this->Parent(), __this, ::STRINGS[1/*"C:\\Users\\...*/], 64, ::STRINGS[2/*"OnRooted"*/]);

    __this->_boundsElement = uAs< ::g::Fuse::Elements::Element*>(__this->Parent(), ::TYPES[5/*Fuse.Elements.Element*/]);

    if (__this->_boundsElement == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[3/*"Element"*/], __this->Parent(), __this, ::STRINGS[1/*"C:\\Users\\...*/], 68, ::STRINGS[2/*"OnRooted"*/]);
    else
...
::g::Fuse::Controls::RangeControl* LinearRangeBehavior::FindRangeControl()
{
    ...
    while ((p != NULL) && !uIs(p, ::TYPES[6/*Fuse.Controls.RangeControl*/]))
        p = uPtr(p)->Parent();

    return uAs< ::g::Fuse::Controls::RangeControl*>(p, ::TYPES[6/*Fuse.Controls.RangeControl*/]);
}
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Scroller.uno
// ----------------------------------------------------------------------------------------
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Scroller.DelayStart is no longer supported."), this, uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Scroller.uno"), 49, uString::Const("set_DelayStart"));
}
...
void Scroller::OnRequestBringIntoView(uObject* sender, ::g::Fuse::RequestBringIntoViewArgs* args)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)Scroller__PerformBringIntoView_fn, this), 1, 5);
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid scroller update"), NULL, uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Scroller.uno"), 384, uString::Const("OnUpdated"));
        return;
    }
...
{
    if (!_pressed)
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)::g::Fuse::Visual__InvalidateVisual_fn, uPtr(_scrollable)), 0);
...
{
    if (_pressed)
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)::g::Fuse::Visual__InvalidateVisual_fn, uPtr(_scrollable)), 0);
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Scroller.uno"), 129, uString::Const("UpdatePointerEvents"));
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Scroller.uno"), 136, uString::Const("UpdatePointerEvents"));
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Scroller.Actions.uno
// ------------------------------------------------------------------------------------------------
...
static void ScrollTo_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Scroller.Actions.uno");
    ::STRINGS[6] = uString::Const("Perform");
    ::TYPES[7] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void ScrollTo__Perform_fn(ScrollTo* __this, ::g::Fuse::Node* target)
{
    ...
    ind1 = __this->Target();
    ::g::Fuse::Controls::ScrollView* scrollView = (ind1 != NULL) ? ind1 : (::g::Fuse::Controls::ScrollView*)uPtr(target)->FindByType(::TYPES[7/*Fuse.Node.FindByType<Fuse.Controls.ScrollView>*/]);

    if (scrollView == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Unabled to ...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 106, ::STRINGS[6/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Swipe.uno
// --------------------------------------------------------------------------
...
{
    ::TYPES[8] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void Swiped__OnRooted_fn(Swiped* __this)
{
    ...
    uPtr(__this->_region)->add_Swiped(uDelegate::New(::TYPES[8/*Uno.Action<bool, bool>*/], (void*)Swiped__OnSwiped_fn, __this));
}
...
{
    uPtr(__this->_region)->remove_Swiped(uDelegate::New(::TYPES[8/*Uno.Action<bool, bool>*/], (void*)Swiped__OnSwiped_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
static void SwipeGesture__cctor_1_fn(uType* __type)
{
    ...
    SwipeGesture::GesturePriorityName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[7/*"GesturePrio...*/]);
    SwipeGesture::_isActiveName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[8/*"IsActive"*/]);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("Element");
    ::STRINGS[9] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\1.4.0\\Swipe.uno");
    ::STRINGS[2] = uString::Const("OnRooted");
    ::TYPES[5] = ::g::Fuse::Elements::Element_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
...
{
    ::g::Fuse::Node__OnRooted_fn(__this);
    ::g::Fuse::Elements::Element* element = uAs< ::g::Fuse::Elements::Element*>(__this->Parent(), ::TYPES[5/*Fuse.Elements.Element*/]);

    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[3/*"Element"*/], __this->Parent(), __this, ::STRINGS[9/*"C:\\Users\\...*/], 236, ::STRINGS[2/*"OnRooted"*/]);
        return;
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Tapped.uno
// ---------------------------------------------------------------------------
...
{
    ::TYPES[9] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Gestures.Tapped>*/, type, NULL);
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[1] = ::g::Fuse::Gestures::ClickerEventHandler_typeof();
...
void Tapped__OnRooted_fn(Tapped* __this)
{
    ...
    uPtr(__this->Clicker)->add_TappedEvent(uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], (void*)Tapped__OnTapped_fn, __this));
}
...
{
    uPtr(__this->Clicker)->remove_TappedEvent(uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], (void*)Tapped__OnTapped_fn, __this));
...
{
    Tapped* t = (Tapped*)uPtr(visual)->FirstChild(::TYPES[9/*Fuse.Visual.FirstChild<Fuse.Gestures.Tapped>*/]);

    if (t == NULL)
    {
        t = Tapped::New2();
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), t);
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Pressed.uno
// ----------------------------------------------------------------------------
...
void WhilePressed__OnRooted_fn(WhilePressed* __this)
{
    ...
    if (__this->Capture())
    {
        ...
        uPtr(__this->Clicker)->add_PressingEvent(uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], (void*)WhilePressed__OnClickerPressing_fn, __this));
    }
    else
    {
...
void WhilePressed__OnUnrooted_fn(WhilePressed* __this)
{
    if (__this->Capture())
    {
        uPtr(__this->Clicker)->remove_PressingEvent(uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickerEventHandler*/], (void*)WhilePressed__OnClickerPressing_fn, __this));
        uPtr(__this->Clicker)->Detach();
        __this->Clicker = NULL;
    }
    else
