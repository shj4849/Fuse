...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\CircleLayout.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\GridLayout.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\ColumnLayout.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\DefaultLayout.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\DockLayout.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\WrapLayout.uno
// ----------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Panels\\1.4.0\\Layouts\\GridLayout.uno");
    ...
    ::TYPES[28] = ::TYPES[14/*Uno.Collections.ICollection`1*/]->MakeType(::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[29] = type->MakeMethod(4/*ModifyCount<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
...
{
    ModifyCount(::TYPES[29/*Fuse.Layouts.GridLayout.ModifyCount<Fuse.Layouts.Row>*/], (uObject*)_rows, value, _defaultRow);
}
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\Layout.uno
// ------------------------------------------------------------------------------------------
...
static void Layout_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    ::TYPES[30] = ::g::Fuse::Elements::Element_typeof();
    type->SetFields(1,
...
bool Layout::ArrangeMarginBoxSpecial(::g::Fuse::Node* n, ::g::Uno::Float4 padding, ::g::Fuse::LayoutParams lp)
{
    ...
    if (lr == 3)
    {
        ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(e, ::TYPES[30/*Fuse.Elements.Element*/]);
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.0\Layouts\StackLayout.uno
// -----------------------------------------------------------------------------------------------
...
{
    ::TYPES[31] = ::g::Uno::Float4_typeof()->Array();
...
::g::Uno::Float2 WrapLayout::Arrange(::g::Fuse::Visual* container, ::g::Fuse::LayoutParams lp, bool doArrange, ::g::Uno::Float4 padding)
{
    ...
    uArray* placements = uArray::New(::TYPES[31/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(container)->Children()), ::TYPES[32/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* minorSizes = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[32/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* elementOnRow = uArray::New(::TYPES[33/*int[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[32/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* majorRest = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[32/*Uno.Collections.ICollection<Fuse.Node>*/])));
    int majorStart = 0;
    int currentRow = 0;
    int i = 0;
    ...
    for (int j1 = majorStart; j1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[32/*Uno.Collections.ICollection<Fuse.Node>*/])); ++j1)
