// This file was generated based on C:/Users/t2/AppData/Local/Fusetools/Packages/UnoCore/1.4.3/Backends/CPlusPlus/Uno/_mainMobile.cpp.
...
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* App1_accessor_Fuse_Controls_Page_Title_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* App1_accessor_PageWithTitle_HeaderColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* App1_accessor_PageWithTitle_HeaderTextColor_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* App1_accessor_PageWithTitle_Instructions_typeof();}
namespace g{uClassType* App1_bundle_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseControlsPanel_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseControlsRectangle_CornerRadius_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseControlsShape_Color_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseControlsTextControl_TextColor_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseEffectsBlur_Radius_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseElementsElement_Height_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseElementsElement_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App1_FuseReactiveEach_Items_Property_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* PageWithTitle_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::App1_accessor_Fuse_Controls_Page_Title_typeof,
        (uType*(*)())&::g::App1_accessor_PageWithTitle_HeaderColor_typeof,
        (uType*(*)())&::g::App1_accessor_PageWithTitle_HeaderTextColor_typeof,
        (uType*(*)())&::g::App1_accessor_PageWithTitle_Instructions_typeof,
        (uType*(*)())&::g::App1_bundle_typeof,
        (uType*(*)())&::g::App1_FuseControlsPanel_Color_Property_typeof,
        (uType*(*)())&::g::App1_FuseControlsRectangle_CornerRadius_Property_typeof,
        (uType*(*)())&::g::App1_FuseControlsShape_Color_Property_typeof,
        (uType*(*)())&::g::App1_FuseControlsTextControl_TextColor_Property_typeof,
        (uType*(*)())&::g::App1_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::App1_FuseEffectsBlur_Radius_Property_typeof,
        (uType*(*)())&::g::App1_FuseElementsElement_Height_Property_typeof,
        (uType*(*)())&::g::App1_FuseElementsElement_Opacity_Property_typeof,
        (uType*(*)())&::g::App1_FuseReactiveEach_Items_Property_typeof,
