...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Triggers\Actions\BringIntoView.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls\1.4.0\Triggers\BringToFront.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Callback.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\CancelInteractions.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Visibility.uno
// ---------------------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\Visibility.uno");
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\DebugAction.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\DebugProperty.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\EvaluateJS.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Focus.uno
// ----------------------------------------------------------------------------------
...
void Hide__Perform_fn(Hide* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 74, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Toggle.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\WebViewNavActions.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Pulse.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.UserEvents\1.4.0\RaiseUserEvent.uno
// -------------------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.4.0\\RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\1.4.0\NavigationActions.uno
// -------------------------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\1.4.0\\NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[9/*"Requires a ...*/], __this, ::STRINGS[10/*"C:\\Users\\...*/], 26, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Set.uno
// --------------------------------------------------------------------------------
...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\TimelineAction.uno
// -------------------------------------------------------------------------------------------
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"`TimelineAc...*/], __this, ::STRINGS[13/*"C:\\Users\\...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[14/*"Could not f...*/], __this, ::STRINGS[15/*"C:\\Users\\...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.0\\Triggers\\LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[25] = ::g::Uno::Action_typeof();
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[16/*"Missing `Fr...*/], __this, ::STRINGS[17/*"C:\\Users\\...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\StateTransition.uno
// --------------------------------------------------------------------------------------------
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("C:\\Users\\t2\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"Missing `Ta...*/], __this, ::STRINGS[19/*"C:\\Users\\...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\TriggerAction.uno
// ------------------------------------------------------------------------------------------
