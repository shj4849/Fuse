...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.4.0\Interfaces.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.4.0\ImageLoader.uno
// ---------------------------------------------------------------------------------------
...
void ImageLoader::ReleaseHandle(::g::Fuse::Controls::Native::ImageHandle* handle)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(ImageLoader::_imageHandleCache_), uPtr(handle)->Name(), &ret7), ret7))
    {
        ...
        ImageLoader::Release(uCast< ::g::Java::Object*>(handle->Handle(), ::g::Java::Object_typeof()));
    }
}
// }

// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\ViewHandle.Android.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.4.0\NativeRootViewport.uno
// ----------------------------------------------------------------------------------------------
...
void ImageLoader__PendingPromise::ctor_7(::g::Uno::Threading::Future1* future)
{
    ctor_3();
    _future = future;
    uPtr(_future)->Then(uDelegate::New(::TYPES[5/*Uno.Action<Fuse.Controls.Native.ImageHandle>*/], (void*)ImageLoader__PendingPromise__OnResolve_fn, this));
}
