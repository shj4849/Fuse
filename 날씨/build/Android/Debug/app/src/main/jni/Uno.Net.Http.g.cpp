...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/t2/AppData/Local/Fusetools/Packages/Uno.Net.Http/1.4.3/HttpMessageCache.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized_)
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"Uno.Net.Htt...*/], 0, ::STRINGS[1/*"C:/Users/t2...*/], 15);
    else
