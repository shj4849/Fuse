...
{
    FuseScriptingJavaScript_bundle::Diagnostics7c89eba5_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[151/*"Fuse.Script...*/]))->GetFile(::STRINGS[152/*"diagnostics...*/]);
    FuseScriptingJavaScript_bundle::es6promisemin8262893e_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[151/*"Fuse.Script...*/]))->GetFile(::STRINGS[153/*"es6-promise...*/]);
    FuseScriptingJavaScript_bundle::Observablebead7a7c_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[151/*"Fuse.Script...*/]))->GetFile(::STRINGS[154/*"observable-...*/]);
    FuseScriptingJavaScript_bundle::setTimeoutff29abd6_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[151/*"Fuse.Script...*/]))->GetFile(::STRINGS[155/*"settimeout-...*/]);
}
