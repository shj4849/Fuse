...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux13\Outracks.Simulator.Client.Dialogs.LoadingScreen.g.uno
// ------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\t2\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux13\Outracks.Simulator.Client.Dialogs.ModalDialog.g.uno
// ----------------------------------------------------------------------------------------------------------------------------------
...
void ModalDialog::InitializeUX()
{
    ...
    temp15->File(::g::Uno::UX::BundleFileSource::New1(::g::FusePreviewCore_bundle::fight23829244()));
    temp->TextWrapping(1);
    temp->FontSize(25.0f);
    temp->TextAlignment(1);
    temp->Alignment(8);
