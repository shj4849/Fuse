...
{
    uStackFrame __("App1_FuseControlsRectangle_CornerRadius_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("App1_FuseControlsRectangle_CornerRadius_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
