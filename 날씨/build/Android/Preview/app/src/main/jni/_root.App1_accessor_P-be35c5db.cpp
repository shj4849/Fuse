...
{
    uStackFrame __("App1_accessor_PageWithTitle_HeaderTextColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("App1_accessor_PageWithTitle_HeaderTextColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
