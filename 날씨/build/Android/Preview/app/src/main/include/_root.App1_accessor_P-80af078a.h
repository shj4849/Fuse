...
namespace g{struct App1_accessor_PageWithTitle_HeaderColor;}
...
struct App1_accessor_PageWithTitle_HeaderColor : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static App1_accessor_PageWithTitle_HeaderColor* New1();
};
// }
