...
{
    uStackFrame __("App1_accessor_PageWithTitle_Instructions", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("App1_accessor_PageWithTitle_Instructions", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
