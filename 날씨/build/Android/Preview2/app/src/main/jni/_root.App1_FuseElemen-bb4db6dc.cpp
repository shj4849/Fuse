...
{
    uStackFrame __("App1_FuseElementsElement_Opacity_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("App1_FuseElementsElement_Opacity_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
