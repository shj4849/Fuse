...
{
    uStackFrame __("App1_accessor_Fuse_Controls_Page_Title", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("App1_accessor_Fuse_Controls_Page_Title", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
