...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        temp_Items_inst = new swipegesturereveal_FuseReactiveEach_Items_Property(temp, __selector0);
        var temp18 = new global::Fuse.Reactive.Data("pagesView");
        ...
        var temp29 = new global::Fuse.Reactive.DataBinding(temp_Items_inst, temp18, Fuse.Reactive.BindingMode.Default);
        temp19.Background = temp22;
        ...
        temp21.File = new global::Uno.UX.BundleFileSource(import("../../../../../MainView.js"));
        temp22.StartPoint = float2(0f, 0f);
        temp22.EndPoint = float2(0f, 1f);
        temp22.Stops.Add(temp23);
        temp22.Stops.Add(temp24);
        temp23.Offset = 0f;
        temp23.Color = float4(0.8078431f, 0.8392157f, 0.8705882f, 1f);
        temp24.Offset = 1f;
        temp24.Color = float4(0.5764706f, 0.6784314f, 0.7411765f, 1f);
        temp25.Children.Add(temp26);
        temp26.InactiveState = Fuse.Controls.NavigationControlInactiveState.Unchanged;
        temp26.Transition = Fuse.Controls.NavigationControlTransition.None;
        temp26.Motion = temp27;
        temp26.Children.Add(temp);
        temp27.GotoDuration = 0.3f;
        temp27.GotoEasing = Fuse.Animations.Easing.QuadraticOut;
