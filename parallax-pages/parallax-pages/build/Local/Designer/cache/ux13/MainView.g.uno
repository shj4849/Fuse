...
public partial class MainView: Fuse.App
{
    ...
    static MainView()
    {
        ...
        RobotoThinItalic = new global::Fuse.Font(new global::Uno.UX.BundleFileSource(import("../../../../../assets/Roboto-ThinItalic.ttf")));
    ...
    void InitializeUX()
    {
        ...
        var temp18 = new global::ParallaxPage();
        var temp19 = new global::ParallaxPage();
        var temp20 = new global::ParallaxPage();
        var temp21 = new global::ParallaxPage();
        temp17.Style = Fuse.Platform.StatusBarStyle.Light;
        pageControl.InactiveState = Fuse.Controls.NavigationControlInactiveState.Unchanged;
        pageControl.Name = __selector0;
        pageControl.Children.Add(temp18);
        pageControl.Children.Add(temp19);
        pageControl.Children.Add(temp20);
        pageControl.Children.Add(temp21);
        temp18.TitleText = "TECH";
        temp18.ThemeColor = float4(0.6117647f, 0.1529412f, 0.6901961f, 1f);
        temp18.ImageFile = new global::Uno.UX.BundleFileSource(import("../../../../../assets/tech.jpg"));
        temp19.TitleText = "CULTURE";
        temp19.ThemeColor = float4(0.9137255f, 0.1176471f, 0.3882353f, 1f);
        temp19.ImageFile = new global::Uno.UX.BundleFileSource(import("../../../../../assets/culture.jpg"));
        temp20.TitleText = "SPORTS";
        temp20.ThemeColor = float4(0.2627451f, 0.627451f, 0.2784314f, 1f);
        temp20.ImageFile = new global::Uno.UX.BundleFileSource(import("../../../../../assets/sports.jpg"));
        temp21.TitleText = "BUSINESS";
        temp21.ThemeColor = float4(0.1019608f, 0.1372549f, 0.4941176f, 1f);
        temp21.ImageFile = new global::Uno.UX.BundleFileSource(import("../../../../../assets/business.jpg"));
        this.Children.Add(temp17);
        this.Children.Add(pageControl);
    }
    static global::Uno.UX.Selector __selector0 = "pageControl";
}
